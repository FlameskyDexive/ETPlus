...
{
    [BtInfo("Composite: run in parallel, run all sub-nodes, exit and return Failure if an error is returned, otherwise wait for all sub-nodes to return correct at the same time;" +
