...
namespace BehaviorTree.Editor
{
    ...
    internal class EditorSetting
    {
        ...
        public string EditorName = "BehaviorTree";
        [BtGroupSelector, Tooltip("Display type, filter BTGroup according to this list, nodes without category will always be displayed")]
        public string[] ShowGroups = new string[0];
        [BtGroupSelector, Tooltip("The type that is not displayed, filter the BTGroup according to this list, and the nodes without categories will always be displayed")]
    ...
    public class BehaviorTreeSetting : ScriptableObject
    {
        ...
        private const string k_UserServiceSettingPath = "Assets/BehaviorTreeUserServiceData.asset";
        private const string GraphFallBackPath = "Data/Graph";
        private const string InspectorFallBackPath = "Data/Inspector";
        private const string NodeFallBackPath = "Data/Node";
            ...
            get
            {
                if (serviceData == null)
                {
                    ...
                    if (guids.Length == 0)
                    {
                        ...
                        Debug.Log($"BT User Service Data saving path : {k_UserServiceSettingPath}");
        ...
        public static BehaviorTreeSetting GetOrCreateSettings()
        {
            ...
            if (guids.Length == 0)
            {
                ...
                Debug.Log($"BT Setting saving path : {k_BehaviorTreeSettingsPath}");
    ...
    internal class BehaviorTreeSettingsProvider : SettingsProvider
    {
        ...
        private const string ReflectionSymbol = "BT_REFLECTION";
        ...
        public static SettingsProvider CreateMyCustomSettingsProvider()
        {
            ...
            var provider = new BehaviorTreeSettingsProvider("Project/BahaviorTree Settings", SettingsScope.Project)
            {
